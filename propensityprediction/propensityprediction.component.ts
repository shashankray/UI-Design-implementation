...
@Component({
    moduleId: module.id,
    selector: 'propensityprediction-cmp',
    templateUrl: 'propensityprediction.component.html',
...
export class PropensitypredictionComponent implements OnInit, OnDestroy {
